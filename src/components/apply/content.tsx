      ...
      <header className="h-screen min-h-screen w-screen bg-white">
        <div className="relative h-screen flex align-center flex-col justify-center text-center bg-cover" style={{backgroundImage: `url('https://images.pexels.com/photos/346529/pexels-photo-346529.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')`}}>
          ...
          <form action="#" className="mx-auto max-w-[24rem] text-left">
            <Input color="white" size="lg" label="First Name" type="fn" name="First Name" crossOrigin={undefined}/>
            <Input color="white" size="lg" label="Last Name" type="ln" name="Last Name" crossOrigin={undefined}/>
            <Input color="white" size="lg" label="Age" type="age" name="Age" crossOrigin={undefined}/>
            <Input color="white" size="lg" label="Occupation" type="occupation" name="Occupation" crossOrigin={undefined}/>
